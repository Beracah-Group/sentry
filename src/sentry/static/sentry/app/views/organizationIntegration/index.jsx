...
export default class OrganizationIntegration extends AsyncView {
  ...
  handleRemoveProjectIntegration = integration => {
    ...
    const options = {
      method: 'DELETE',
      success: () => {
        delete integration.config_data_projects[projectId];
  ...
  handleEnableProjectIntegration = integration => {
    ...
    const options = {
      ...
      success: () => {
        ...
        // config_data_projects list within the integration object. Later this
        ...
        integration.config_data_projects[projectId] = {};
        this.mergeIntegration(integration);
